...
RegisterNetEvent('afisy-parkingmeter:server:payParking', function(pos)
    local src = source
...
QBCore.Functions.CreateCallback('afisy-parkingmeter:server:checkParking', function(source, cb, pos)
